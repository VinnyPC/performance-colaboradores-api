...
class AvaliacaoComportamentalItem(db.Model):
    __tablename__ = 'tb_avaliacao_comportamental_item'

    id = db.Column(db.Integer, primary_key=True)
    avaliacao_comportamental_id = db.Column(
        db.Integer, db.ForeignKey('tb_avaliacao_comportamental.id'), nullable=False
    )
